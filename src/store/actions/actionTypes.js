export const FETCH_DISHE_REQUEST = 'FETCH_DISHE_REQUEST';
export const FETCH_DISHE_SUCCESS = 'FETCH_DISHE_SUCCESS';
export const FETCH_DISHE_FAILURE = 'FETCH_DISHE_FAILURE';
